...
The same project can be opened from the Streamlit app after the notebook creates
it. The Streamlit app starts from the project creation/opening flow and does not
create the demo automatically.
